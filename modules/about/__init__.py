...
def show_about_dialog(config, parent=None, test_mode=False):
    ...
    try:
        ...
        app_name = about_info.get('Name') or about_info.get('name', 'PyQt6ify Pro')
        version = about_info.get('Version') or about_info.get('version', '1.0.0')
        author = about_info.get('Author') or about_info.get('author', 'PyQt6ify Team')
        description = about_info.get('Description') or about_info.get('description', '')
        website = about_info.get('Website') or about_info.get('website', '')
        ...
        icon_path = about_info.get('icon') or about_info.get('Icon')
